...
\newcommand\wordcloud{\wordclouding{8pt}{14pt}{Statistical Statistical Analysis Statistical Analysis Analysis  Proofs of Concept Business Intuition Business Intuition Quantitative Research Quantitative Research Quantitative Research Teaching Monte Carlo Monte Carlo Angular.js Hadoop Pandas Pandas Pandas Pandas Matplotlib Seaborn Lattice Tree Lattice Tree Stochastic Calculus }}
%----------------------------------------------------------------------------------------
